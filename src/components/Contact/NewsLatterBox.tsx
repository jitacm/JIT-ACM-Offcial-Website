...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      Want to stay in the loop with the latest tech trends, exciting events, and exclusive opportunities? Subscribe to our ACM Student Chapter newsletter and never miss a beat! 
      </p>
      <div>
        <input
          type="text"
