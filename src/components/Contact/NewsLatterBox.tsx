...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 h-full rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      <h3 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white"></h3>
      ...
      <div>
        <p className="text-center text-base leading-relaxed text-body-color dark:text-body-color-dark"></p>
      </div>
