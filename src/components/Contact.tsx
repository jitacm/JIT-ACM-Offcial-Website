            ...
            <div className="space-y-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-gray-600">Jhulelal Institute of Technology, KH. NO. 68 & 72, Village Lonara, Off, Koradi Rd, Nagpur, Maharashtra 441111</p>
                </div>
              </div>
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-gray-600">acmjit@jitnagpur.edu.in</p>
                </div>
              </div>
              <div className="flex items-center">
